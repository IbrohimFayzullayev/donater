...
const Header = () => {
  return (
    <div
      className='sticky left-0 top-0 py-3 w-full  bg-gray-900 z-50'
    >
      <div className="flex items-center justify-between text-lg text-gray-700 font-sans w-3/5 my-0 mx-auto">
        <Link to='/'>
          <img className="h-12" src="https://maimoon.uz/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flogo.c28560d0.png&w=256&q=75" alt="logo" />
        </Link>
